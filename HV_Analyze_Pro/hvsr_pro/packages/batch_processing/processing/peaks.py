...
def sesame_peak_criteria(peak: Peak,
    ...
    # Criterion 1: f0 > 10 / lw (assuming 30s windows -> f0 > 0.33 Hz)
    criteria['f0_gt_10/lw'] = f0 > 0.33
    
    # Criterion 2: Number of significant cycles (assume pass)
    criteria['nc_gt_200'] = True
    
    # Criterion 3: Standard deviation of A0 (assume pass)
